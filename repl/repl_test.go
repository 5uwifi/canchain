...
const (
	...
	testAddress  = "0x0000000000008605cdbbdb6d264aa742e77020dcbc58fcdce182"
)
...
func newTester(t *testing.T, confOverride func(*ledger.Config)) *tester {
	...
	ethConf := &ledger.Config{
		Genesis:   kernel.DeveloperGenesisBlock(15, common.Address{}),
		Canerbase: common.HexToAddress(testAddress),
		Canhash: canhash.Config{
			PowMode: canhash.ModeTest,
		},
	}
	if confOverride != nil {
		confOverride(ethConf)
	}
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return ledger.New(ctx, ethConf) }); err != nil {
