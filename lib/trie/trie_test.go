...
func newEmpty() *Trie {
	trie, _ := New(common.Hash{}, NewDatabase(candb.NewMemDatabase()))
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	trie, err := New(common.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), NewDatabase(candb.NewMemDatabase()))
	if trie != nil {
...
func benchGet(b *testing.B, commit bool) {
	...
	if commit {
		ldb := trie.db.diskdb.(*candb.LDBDatabase)
		ldb.Close()
...
func tempDB() (string, *Database) {
	...
	diskdb, err := candb.NewLDBDatabase(dir, 256, 0)
	if err != nil {
