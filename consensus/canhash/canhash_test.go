...
// Tests that canhash works correctly in test mode.
...
func TestCacheFileEvict(t *testing.T) {
	tmpdir, err := ioutil.TempDir("", "canhash-test")
	if err != nil {
		t.Fatal(err)
	}
...
func verifyTest(wg *sync.WaitGroup, e *Canhash, workerIndex, epochs int) {
	defer wg.Done()
