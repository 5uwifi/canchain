...
func (alwaysDenyUI) OnApprovedTx(tx canapi.SignTransactionResult) {
	panic("implement me")
}
...
func (d *dummyUI) OnApprovedTx(tx canapi.SignTransactionResult) {
...
func (d *dontCallMe) OnApprovedTx(tx canapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
