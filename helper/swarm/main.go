...
import (
	...
	"github.com/5uwifi/canchain/basis/swarm"
	bzzapi "github.com/5uwifi/canchain/basis/swarm/api"
	swarmmetrics "github.com/5uwifi/canchain/basis/swarm/metrics"
...
var (
	...
	testbetBootNodes = []string{
		"ccnode://ec8ae764f7cb0417bdfb009b9d0f18ab3818a3a4e8e7c67dd5f18971a93510a2e6f43cd0b69a27e439a9629457ea804104f37c85e41eed057d3faabbf7744cdf@13.74.157.139:30429",
		"ccnode://c2e1fceb3bf3be19dff71eec6cccf19f2dbf7567ee017d130240c670be8594bc9163353ca55dd8df7a4f161dd94b36d0615c17418b5a3cdcbb4e9d99dfa4de37@13.74.157.139:30430",
		"ccnode://fe29b82319b734ce1ec68b84657d57145fee237387e63273989d354486731e59f78858e452ef800a020559da22dcca759536e6aa5517c53930d29ce0b1029286@13.74.157.139:30431",
		"ccnode://1d7187e7bde45cf0bee489ce9852dd6d1a0d9aa67a33a6b8e6db8a4fbc6fcfa6f0f1a5419343671521b863b187d1c73bad3603bae66421d157ffef357669ddb8@13.74.157.139:30432",
		"ccnode://0e4cba800f7b1ee73673afa6a4acead4018f0149d2e3216be3f133318fd165b324cd71b81fbe1e80deac8dbf56e57a49db7be67f8b9bc81bd2b7ee496434fb5d@13.74.157.139:30433",
	}
)
...
func bzzd(ctx *cli.Context) error {
	...
	go func() {
		...
		<-sigc
		log4j.Info("Got sigterm, shutting swarm down...")
		stack.Stop()
	}()
...
func getAccount(bzzaccount string, ctx *cli.Context, stack *node.Node) *ecdsa.PrivateKey {
	...
	if key, err := crypto.LoadECDSA(bzzaccount); err == nil {
		log4j.Info("Swarm account key loaded", "address", crypto.PubkeyToAddress(key.PublicKey))
		return key
	}
...
func getPassPhrase(prompt string, i int, passwords []string) string {
	...
	password, err := repl.Stdin.PromptPassword("Passphrase: ")
	if err != nil {
...
func injectBootnodes(srv *p2p.Server, nodes []string) {
	for _, url := range nodes {
		...
		if err != nil {
			log4j.Error("Invalid swarm bootnode", "err", err)
			continue
		}
		srv.AddPeer(n)
	}
