...
func (ta *testAPI) uploadAndMount(dat *testData, t *testing.T) (*testData, error) {
	...
	log4j.Debug("Created test files and uploaded to Swarm")
	//mount the directory
	dat.swarmfs = mountDir(t, ta.api, dat.files, dat.bzzHash, dat.testMountDir)
	log4j.Debug("Mounted swarm fs")
	return dat, nil
}
...
func (ta *testAPI) mountListAndUnmountEncrypted(t *testing.T) {
	log4j.Debug("Starting mountListAndUnmountEncrypted test")
	ta.mountListAndUnmount(t, true)
	log4j.Debug("Test mountListAndUnmountEncrypted terminated")
}

func (ta *testAPI) mountListAndUnmountNonEncrypted(t *testing.T) {
	log4j.Debug("Starting mountListAndUnmountNonEncrypted test")
	ta.mountListAndUnmount(t, false)
	log4j.Debug("Test mountListAndUnmountNonEncrypted terminated")
}
...
func (ta *testAPI) mountListAndUnmount(t *testing.T, toEncrypt bool) {
	...
	log4j.Debug("Unmount successful")
	if !isDirEmpty(dat.testMountDir) {
		t.Fatalf("unmount didnt work for %v", dat.testMountDir)
	}
	log4j.Debug("subtest terminated")
}

func (ta *testAPI) maxMountsEncrypted(t *testing.T) {
	log4j.Debug("Starting maxMountsEncrypted test")
	ta.runMaxMounts(t, true)
	log4j.Debug("Test maxMountsEncrypted terminated")
}

func (ta *testAPI) maxMountsNonEncrypted(t *testing.T) {
	log4j.Debug("Starting maxMountsNonEncrypted test")
	ta.runMaxMounts(t, false)
	log4j.Debug("Test maxMountsNonEncrypted terminated")
}
...
func (ta *testAPI) runMaxMounts(t *testing.T, toEncrypt bool) {
	...
	log4j.Debug("Created test files and uploaded to swarm with uploadDir6")
	...
	log4j.Debug("Maximum mount reached, additional mount failed. Correct.")
}

func (ta *testAPI) remountEncrypted(t *testing.T) {
	log4j.Debug("Starting remountEncrypted test")
	ta.remount(t, true)
	log4j.Debug("Test remountEncrypted terminated")
}
func (ta *testAPI) remountNonEncrypted(t *testing.T) {
	log4j.Debug("Starting remountNonEncrypted test")
	ta.remount(t, false)
	log4j.Debug("Test remountNonEncrypted terminated")
}
...
func (ta *testAPI) remount(t *testing.T, toEncrypt bool) {
	...
	log4j.Debug("Mount on existing mount point failed. Correct.")
	...
	log4j.Debug("Nonexistent hash hasn't been mounted. Correct.")
}

func (ta *testAPI) unmountEncrypted(t *testing.T) {
	log4j.Debug("Starting unmountEncrypted test")
	ta.unmount(t, true)
	log4j.Debug("Test unmountEncrypted terminated")
}

func (ta *testAPI) unmountNonEncrypted(t *testing.T) {
	log4j.Debug("Starting unmountNonEncrypted test")
	ta.unmount(t, false)
	log4j.Debug("Test unmountNonEncrypted terminated")
}
...
func (ta *testAPI) unmount(t *testing.T, toEncrypt bool) {
	...
	log4j.Debug("Unmounted Dir")

	mi := swarmfs.Listmounts()
	log4j.Debug("Going to list mounts")
	for _, minfo := range mi {
		log4j.Debug("Mount point in list: ", "point", minfo.MountPoint)
...
func (ta *testAPI) unmountWhenResourceBusyEncrypted(t *testing.T) {
	log4j.Debug("Starting unmountWhenResourceBusyEncrypted test")
	ta.unmountWhenResourceBusy(t, true)
	log4j.Debug("Test unmountWhenResourceBusyEncrypted terminated")
}
func (ta *testAPI) unmountWhenResourceBusyNonEncrypted(t *testing.T) {
	log4j.Debug("Starting unmountWhenResourceBusyNonEncrypted test")
	ta.unmountWhenResourceBusy(t, false)
	log4j.Debug("Test unmountWhenResourceBusyNonEncrypted terminated")
}
...
func (ta *testAPI) seekInMultiChunkFileEncrypted(t *testing.T) {
	log4j.Debug("Starting seekInMultiChunkFileEncrypted test")
	ta.seekInMultiChunkFile(t, true)
	log4j.Debug("Test seekInMultiChunkFileEncrypted terminated")
}

func (ta *testAPI) seekInMultiChunkFileNonEncrypted(t *testing.T) {
	log4j.Debug("Starting seekInMultiChunkFileNonEncrypted test")
	ta.seekInMultiChunkFile(t, false)
	log4j.Debug("Test seekInMultiChunkFileNonEncrypted terminated")
}
...
func (ta *testAPI) createNewFileEncrypted(t *testing.T) {
	log4j.Debug("Starting createNewFileEncrypted test")
	ta.createNewFile(t, true)
	log4j.Debug("Test createNewFileEncrypted terminated")
}

func (ta *testAPI) createNewFileNonEncrypted(t *testing.T) {
	log4j.Debug("Starting createNewFileNonEncrypted test")
	ta.createNewFile(t, false)
	log4j.Debug("Test createNewFileNonEncrypted terminated")
}
...
func (ta *testAPI) createNewFile(t *testing.T, toEncrypt bool) {
	...
	log4j.Debug("Directory unmounted")
	...
	log4j.Debug("Directory mounted again")
...
func (ta *testAPI) createNewFileInsideDirectoryEncrypted(t *testing.T) {
	log4j.Debug("Starting createNewFileInsideDirectoryEncrypted test")
	ta.createNewFileInsideDirectory(t, true)
	log4j.Debug("Test createNewFileInsideDirectoryEncrypted terminated")
}

func (ta *testAPI) createNewFileInsideDirectoryNonEncrypted(t *testing.T) {
	log4j.Debug("Starting createNewFileInsideDirectoryNonEncrypted test")
	ta.createNewFileInsideDirectory(t, false)
	log4j.Debug("Test createNewFileInsideDirectoryNonEncrypted terminated")
}
...
func (ta *testAPI) createNewFileInsideNewDirectoryEncrypted(t *testing.T) {
	log4j.Debug("Starting createNewFileInsideNewDirectoryEncrypted test")
	ta.createNewFileInsideNewDirectory(t, true)
	log4j.Debug("Test createNewFileInsideNewDirectoryEncrypted terminated")
}

func (ta *testAPI) createNewFileInsideNewDirectoryNonEncrypted(t *testing.T) {
	log4j.Debug("Starting createNewFileInsideNewDirectoryNonEncrypted test")
	ta.createNewFileInsideNewDirectory(t, false)
	log4j.Debug("Test createNewFileInsideNewDirectoryNonEncrypted terminated")
}
...
func (ta *testAPI) removeExistingFileEncrypted(t *testing.T) {
	log4j.Debug("Starting removeExistingFileEncrypted test")
	ta.removeExistingFile(t, true)
	log4j.Debug("Test removeExistingFileEncrypted terminated")
}

func (ta *testAPI) removeExistingFileNonEncrypted(t *testing.T) {
	log4j.Debug("Starting removeExistingFileNonEncrypted test")
	ta.removeExistingFile(t, false)
	log4j.Debug("Test removeExistingFileNonEncrypted terminated")
}
...
func (ta *testAPI) removeExistingFileInsideDirEncrypted(t *testing.T) {
	log4j.Debug("Starting removeExistingFileInsideDirEncrypted test")
	ta.removeExistingFileInsideDir(t, true)
	log4j.Debug("Test removeExistingFileInsideDirEncrypted terminated")
}

func (ta *testAPI) removeExistingFileInsideDirNonEncrypted(t *testing.T) {
	log4j.Debug("Starting removeExistingFileInsideDirNonEncrypted test")
	ta.removeExistingFileInsideDir(t, false)
	log4j.Debug("Test removeExistingFileInsideDirNonEncrypted terminated")
}
...
func (ta *testAPI) removeNewlyAddedFileEncrypted(t *testing.T) {
	log4j.Debug("Starting removeNewlyAddedFileEncrypted test")
	ta.removeNewlyAddedFile(t, true)
	log4j.Debug("Test removeNewlyAddedFileEncrypted terminated")
}

func (ta *testAPI) removeNewlyAddedFileNonEncrypted(t *testing.T) {
	log4j.Debug("Starting removeNewlyAddedFileNonEncrypted test")
	ta.removeNewlyAddedFile(t, false)
	log4j.Debug("Test removeNewlyAddedFileNonEncrypted terminated")
}
...
func (ta *testAPI) removeNewlyAddedFile(t *testing.T, toEncrypt bool) {
	...
	checkFile(t, dat.testMountDir, "one/2.txt", contents)
	log4j.Debug("file checked")

	err = os.Remove(actualPath)
	if err != nil {
		t.Fatalf("Error removing file: %v", err)
	}
	log4j.Debug("file removed")
...
func (ta *testAPI) addNewFileAndModifyContentsEncrypted(t *testing.T) {
	log4j.Debug("Starting addNewFileAndModifyContentsEncrypted test")
	ta.addNewFileAndModifyContents(t, true)
	log4j.Debug("Test addNewFileAndModifyContentsEncrypted terminated")
}

func (ta *testAPI) addNewFileAndModifyContentsNonEncrypted(t *testing.T) {
	log4j.Debug("Starting addNewFileAndModifyContentsNonEncrypted test")
	ta.addNewFileAndModifyContents(t, false)
	log4j.Debug("Test addNewFileAndModifyContentsNonEncrypted terminated")
}
...
func (ta *testAPI) addNewFileAndModifyContents(t *testing.T, toEncrypt bool) {
	...
	log4j.Debug("line read")
	_, err = d.Write(line1)
	if err != nil {
		t.Fatalf("Error writing random bytes to file: %v", err)
	}
	log4j.Debug("line written")
	err = d.Close()
	if err != nil {
		t.Fatalf("Error closing file: %v", err)
	}
	...
	log4j.Debug("Directory unmounted again")
	...
	log4j.Debug("Directory mounted yet again")
	...
	log4j.Debug("Directory unmounted yet again")
	...
	log4j.Debug("Directory mounted final time")
...
func (ta *testAPI) removeEmptyDirEncrypted(t *testing.T) {
	log4j.Debug("Starting removeEmptyDirEncrypted test")
	ta.removeEmptyDir(t, true)
	log4j.Debug("Test removeEmptyDirEncrypted terminated")
}

func (ta *testAPI) removeEmptyDirNonEncrypted(t *testing.T) {
	log4j.Debug("Starting removeEmptyDirNonEncrypted test")
	ta.removeEmptyDir(t, false)
	log4j.Debug("Test removeEmptyDirNonEncrypted terminated")
}
...
func (ta *testAPI) removeDirWhichHasFilesEncrypted(t *testing.T) {
	log4j.Debug("Starting removeDirWhichHasFilesEncrypted test")
	ta.removeDirWhichHasFiles(t, true)
	log4j.Debug("Test removeDirWhichHasFilesEncrypted terminated")
}
func (ta *testAPI) removeDirWhichHasFilesNonEncrypted(t *testing.T) {
	log4j.Debug("Starting removeDirWhichHasFilesNonEncrypted test")
	ta.removeDirWhichHasFiles(t, false)
	log4j.Debug("Test removeDirWhichHasFilesNonEncrypted terminated")
}
...
func (ta *testAPI) removeDirWhichHasSubDirsEncrypted(t *testing.T) {
	log4j.Debug("Starting removeDirWhichHasSubDirsEncrypted test")
	ta.removeDirWhichHasSubDirs(t, true)
	log4j.Debug("Test removeDirWhichHasSubDirsEncrypted terminated")
}

func (ta *testAPI) removeDirWhichHasSubDirsNonEncrypted(t *testing.T) {
	log4j.Debug("Starting removeDirWhichHasSubDirsNonEncrypted test")
	ta.removeDirWhichHasSubDirs(t, false)
	log4j.Debug("Test removeDirWhichHasSubDirsNonEncrypted terminated")
}
...
func (ta *testAPI) appendFileContentsToEndEncrypted(t *testing.T) {
	log4j.Debug("Starting appendFileContentsToEndEncrypted test")
	ta.appendFileContentsToEnd(t, true)
	log4j.Debug("Test appendFileContentsToEndEncrypted terminated")
}

func (ta *testAPI) appendFileContentsToEndNonEncrypted(t *testing.T) {
	log4j.Debug("Starting appendFileContentsToEndNonEncrypted test")
	ta.appendFileContentsToEnd(t, false)
	log4j.Debug("Test appendFileContentsToEndNonEncrypted terminated")
}
