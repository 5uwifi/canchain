...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "can.ipc", false, filepath.Join(os.TempDir(), "can.ipc")},
		{"data", "can.ipc", false, "data/can.ipc"},
		{"data", "./can.ipc", false, "./can.ipc"},
		{"data", "/can.ipc", false, "/can.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "can.ipc", true, `\\.\pipe\can.ipc`},
		{"data", "can.ipc", true, `\\.\pipe\can.ipc`},
		{"data", `\\.\pipe\can.ipc`, true, `\\.\pipe\can.ipc`},
	}
