...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gcan.ipc", false, filepath.Join(os.TempDir(), "gcan.ipc")},
		{"data", "gcan.ipc", false, "data/gcan.ipc"},
		{"data", "./gcan.ipc", false, "./gcan.ipc"},
		{"data", "/gcan.ipc", false, "/gcan.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gcan.ipc", true, `\\.\pipe\gcan.ipc`},
		{"data", "gcan.ipc", true, `\\.\pipe\gcan.ipc`},
		{"data", `\\.\pipe\gcan.ipc`, true, `\\.\pipe\gcan.ipc`},
	}
