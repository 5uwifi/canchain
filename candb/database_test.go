...
func newTestLDB() (*candb.LDBDatabase, func()) {
	...
	db, err := candb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(candb.NewMemDatabase(), t)
}
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(candb.NewMemDatabase(), t)
}

func testParallelPutGet(db candb.Database, t *testing.T) {
	const n = 8
