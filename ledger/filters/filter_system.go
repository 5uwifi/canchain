...
type EventSystem struct {
	...
	txsCh     chan kernel.NewTxsEvent      // Channel to receive new transactions event
	logsCh    chan []*types.Log            // Channel to receive new log event
	rmLogsCh  chan kernel.RemovedLogsEvent // Channel to receive removed log event
	chainCh   chan kernel.ChainEvent       // Channel to receive new chain event
}
