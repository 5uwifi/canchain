...
type downloadTester struct {
	...
	stateDb candb.Database // Database used by the tester for syncing from peers
	peerDb  candb.Database // Database of the peers containing all data
...
func (dl *downloadTester) makeChain(n int, seed byte, parent *types.Block, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]*types.Header, map[common.Hash]*types.Block, map[common.Hash]types.Receipts) {
	...
	blocks, receipts := kernel.GenerateChain(params.TestChainConfig, parent, canhash.NewFaker(), dl.peerDb, n, func(i int, block *kernel.BlockGen) {
