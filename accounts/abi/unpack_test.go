...
var unpackTests = []unpackTest{
	...
	{
		def:  `[{"type": "address"}]`,
		enc:  "0000000000000100000000000000000000000000000000000000000000000000",
...
func TestUnmarshal(t *testing.T) {
	...
	buff.Write(common.Hex2Bytes("0000000000000100000000000000000000000000000000000000000000000000"))
	...
	buff.Write(common.Hex2Bytes("0000000000000200000000000000000000000000000000000000000000000000"))
	buff.Write(common.Hex2Bytes("0000000000000300000000000000000000000000000000000000000000000000"))
